...
class CustomTokenizer(tf.Module):
    def __init__(self, vocab_path):
        ...
        # Create the signatures for tensorflow model save and export:
        self.tokenize.get_concrete_function(
            tf.TensorSpec(shape=[None], dtype=tf.string))
        self.tokenize.get_concrete_function(
            tf.RaggedTensorSpec(shape=[None], dtype=tf.string))
    ...
    def lookup(self, token_ids):
        # given the tokenized text returns the tokens as word-piece text
